...
class RegisterController extends Controller {
    ...
    public function addUsers(){
        ...
        $dynamic_district = TblArea::where('parent_id', 2)
                            ...
                            ->get()
                            ->toArray();
    	return view('admin.pages.users.add-users',compact('roles','permissions','dynamic_district'));
    }
...
// die;
        $rules = [
                ...
                //     'l_name' => 'required|regex:/^[a-zA-Z\s]+$/u|max:255',
                //     'number' =>  'required|regex:/^[0-9]{10}$/',
                //     'aadhar_no' => ['required', 'regex:/^[0-9]{12}$/'],
                //     'imei_no' => ['required', 'regex:/^[0-9]{15}$/'],
        ...
        $messages = [   
                    ...
                    //     'imei_no.required' => 'Please enter IMEI no.',
                    //     'imei_no.regex' => 'Please enter only numbers with 12-digit.',
